export const panelpages = [
{
	"contexts": [
		{
			...
			"data": {
				...
				"remoteEntry": "https://rollthecloudinc.github.io/solid-amcharts5-build/16.0.0-alpha.6/remoteEntry.js"
			},
			"name": "chart_module",
			"plugin": "module"
		}
	...
	"gridItems": [],
	"id": "02380a19-e480-4b01-a437-a06135ba90b7",
	"interactions": {
		"interactions": {
			"listeners": []
		}
